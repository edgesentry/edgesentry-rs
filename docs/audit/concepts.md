...
## 13. IoT security standards and compliance

EdgeSentry-RS targets Singapore CLS Level 3/4, ETSI EN 303 645, JC-STAR, and SS 711:2025.
The full compliance evidence — STRIDE threat model, clause-by-clause traceability matrix, and SBOM — lives in [`docs/security/`](../security/index.md).

For legal admissibility of the audit records themselves (seven requirements, trusted timestamp, RFC 3161 TSA roadmap), see [`docs/legal/`](../legal/index.md).
