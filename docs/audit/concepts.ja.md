...
## 13. IoTセキュリティ規格とコンプライアンス

EdgeSentry-RSはシンガポールCLS Level 3/4、ETSI EN 303 645、JC-STAR、SS 711:2025を対象としています。
コンプライアンス証拠の全体 — STRIDE脅威モデル、条項別トレーサビリティマトリクス、SBOM — は [`docs/security/`](../security/index.ja.md) にあります。

監査記録自体の法的証拠能力（7要件、信頼できるタイムスタンプ、RFC 3161 TSAロードマップ）については [`docs/legal/`](../legal/index.ja.md) を参照してください。
