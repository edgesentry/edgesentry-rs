...
`ingest` is responsible for completing trust checks before persistence.
...
- Run: `cargo run -p ingest --example lift_inspection_flow`
...
See [AGENTS.md](AGENTS.md) for executable procedures.
