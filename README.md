...
| | |
|--|--|
| [Introduction](docs/src/introduction.md) | Vision, three pillars of trust, motivation |
...
| [Library Usage](docs/src/quickstart.md) | **Start here** — in-memory example, no Docker needed |
